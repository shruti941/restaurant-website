...
<html lang="en">
  ...
  <div class="container">
    <div class="row-flex">
      ...
      <form class="media-centered" action="basic.php"  method="post">
          <div class="form-group">
            <p>
              Please leave your number we will call to make a reservation
            </p>
            <input type="name" class="form-control"  name="myname" placeholder="Enter your name">
          </div>
          <div class="form-group">
            <input type="number" name="mynumber" class="form-control"  placeholder="Enter your phone number">
          </div>
